...
from ripeness_classifier.base.config import THUMB_SIZE, _DEST_ROOTS
    ...
    def run(self):
        ...
        for _, thumb in self.items:
            ou, oo, ff, r = compute_ripeness(
                thumb, self.fruit_params, self.unripe_params, self.overripe_params,
